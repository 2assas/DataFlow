...
import com.example.dataflow.databinding.ReceiptsBinding;
...
public class ReceiptScreen extends AppCompatActivity implements MyDialogCloseListener, LocationListener {
    ...
    private void setupViews() {
        ...
        invoiceVM.customerBalanceLiveData.observe(this, customerBalance -> App.customerBalance = customerBalance.getMessage());
    }
