...
import com.example.dataflow.pojo.financialReport.PaymentMethods;
import com.example.dataflow.pojo.financialReport.ReportBody;
import com.example.dataflow.pojo.report.Branches;
import com.example.dataflow.pojo.report.DataItem;
...
public class FinancialReport extends AppCompatActivity {
    ...
    void collectData() {
        if (App.currentUser.getPermission() == 0) {
            ...
            reportVM.getSafeDeposit(App.currentUser.getBranchISN(), uuid);
    ...
    void branchSpinner(Branches branches) {
        ...
        binding.branchSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                reportVM.getSafeDeposit(selectedBranch.getBranchISN(), uuid);
            }
