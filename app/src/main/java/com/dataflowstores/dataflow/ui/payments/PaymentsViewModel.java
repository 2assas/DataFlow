...
public class PaymentsViewModel extends ViewModel {
    ...
    public void createPayment(long BranchISN, String uuid, int CashType, int SaleType, int DealerType, int DealerBranchISN, long DealerISN, long SalesManBranchISN,
        ...
        Observable<ReceiptResponse> receiptResponseObservable = apiClient.createPayment(
                ...
                currentUser.getLogIn_F_Spare3(), App.currentUser.getIllustrativeQuantity(), App.currentUser.getDeviceID(), App.currentUser.getLogIn_CurrentWorkingDayDate(), App.currentUser.getVendorID(), BranchISN, uuid, CashType, SaleType, DealerType, DealerBranchISN, DealerISN, SalesManBranchISN, SalesManISN,
        ...
        receiptResponseObservable.subscribe(new Observer<ReceiptResponse>() {
            ...
            public void onNext(@NonNull ReceiptResponse receiptResponse) {
                paymentResponseMutableLiveData.postValue(receiptResponse);
            }
    ...
    public void getPayment(long branchISN, String uuid, String moveId, long workerCBranchISN, long workerCISN, int permission) {
        ...
        Observable<ReceiptModel> receiptModelObservable = apiClient.getPayment(queryParams, branchISN, uuid, moveId, workerCBranchISN, workerCISN, permission)
        ...
        receiptModelObservable.subscribe(new Observer<ReceiptModel>() {
            ...
            public void onNext(@NonNull ReceiptModel receiptModel) {
                paymentModelMutableLiveData.postValue(receiptModel);
            }
    ...
    public void getCustomerBalance(String uuid, String dealerISN, String branchISN, String dealerType, String moveBranchISN, String moveISN, String remainValue, String netValue, String moveType) {
        Observable<CustomerBalance> customerObservable = apiClient.getCustomerBalance(queryParams, uuid,
                                                                                      dealerISN,
                                                                                      branchISN,
                                                                                      dealerType,
