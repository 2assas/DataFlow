...
public class SupplierSalesPrintScreen extends BaseActivity {
    ...
    void fillInvoice() {
        ...
        App.pdfName = "تقرير مشتريات الاصناف";
        ...
        if (getIntent().getStringExtra("clientName") != null) {
            ...
            binding.clientName.setText("المورد: " + getIntent().getStringExtra("clientName"));
        } else {
    ...
    public void printButton(View view) {
        ...
        handler.postDelayed(() -> {
            takeScreenShot();
            startActivity(new Intent(SupplierSalesPrintScreen.this, PrintScreen.class));
            finish();
        }, 1000);
    }
}
