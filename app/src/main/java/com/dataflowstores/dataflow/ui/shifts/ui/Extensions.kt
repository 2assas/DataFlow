...
import com.dataflowstores.dataflow.pojo.GeneralRequestBody
 ...
 fun getGeneralBody(): GeneralRequestBody {
    ...
    return GeneralRequestBody(
        ...
        SelectedFoundation = App.selectedFoundation,
        IllustrativeQuantity =  user.illustrativeQuantity,
        MobileC_D_B_W_W_C = user.mobileC_D_B_W_W_C,
        MobileOldShiftUse = user.mobileOldShiftUse,
        permission =  user.permission,
        MobileAllowCreateForward =  user.mobileAllowCreateForward,
        MobileAllowCreateForwardAmount =  user.mobileAllowCreateForwardAmount,
        MobileWS_AllowCreateForward =  user.mobileWS_AllowCreateForward,
        MobileWS_AllowCreateForwardAmount =  user.mobileWS_AllowCreateForwardAmount,
        LogIn_F_Spare1 =  user.logIn_F_Spare1,
        LogIn_F_Spare2 = user.logIn_F_Spare2,
        LogIn_F_Spare3 = user.logIn_F_Spare3
    )
}
