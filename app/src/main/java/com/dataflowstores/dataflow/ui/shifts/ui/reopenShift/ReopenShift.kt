package com.dataflowstores.dataflow.ui.shifts.ui.reopenShift
...
class ReopenShift : Fragment() {
    private val viewModel: ReopenShiftViewModel by viewModels()
