...
public class ReportsFragment extends Fragment {
    ...
    private void setupViews() {
        ...
        binding.supplierSalesReport.setOnClickListener(view -> {
            if (App.isNetworkAvailable(requireActivity()))
                startActivity(new Intent(requireActivity(), SupplierSalesReport.class));
        });
    ...
    private void permissions() {
        ...
        if (App.currentUser.getMobileItemsSupplyReport().equals("0")) {
            binding.supplierSalesReport.setEnabled(false);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                binding.supplierSalesReport.setBackground(requireActivity().getDrawable(R.drawable.gray_rounded));
            }
        }
