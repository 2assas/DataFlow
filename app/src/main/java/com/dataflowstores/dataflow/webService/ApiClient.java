...
public interface ApiClient {
    ...
    Observable<Customer> getCustomer(@Query("IllustrativeQuantity") Integer IllustrativeQuantity, @Query("DeviceID") String DeviceID,
            @Query("LogIn_CurrentWorkingDayDate") String LogIn_CurrentWorkingDayDate, @Query("VendorID") Long VendorID, @Query("customer_name") String customer_name,
            @Query("uiid") String uuid, @Query("WorkerBranchISN") Long WorkerBranchISN, @Query("WorkerISN") Long WorkerISN,
            ...
            @Query("MobileSalesMaxDiscPer") Integer MobileSalesMaxDiscPer, @Query("ShiftSystemActivate") Integer ShiftSystemActivate,
            @Query("LogIn_ShiftBranchISN") Integer LogIn_ShiftBranchISN, @Query("LogIn_ShiftISN") Integer LogIn_ShiftISN,
            @Query("LogIn_Spare1") Integer LogIn_Spare1, @Query("LogIn_Spare2") Integer LogIn_Spare2, @Query("LogIn_Spare3") Integer LogIn_Spare3,
            @Query("LogIn_Spare4") Integer LogIn_Spare4, @Query("LogIn_Spare5") Integer LogIn_Spare5, @Query("LogIn_Spare6") Integer LogIn_Spare6);

    @GET("dealer/getSupplier")
    Observable<Customer> getSupplier(@Query("IllustrativeQuantity") Integer IllustrativeQuantity, @Query("DeviceID") String DeviceID,
            @Query("LogIn_CurrentWorkingDayDate") String LogIn_CurrentWorkingDayDate, @Query("VendorID") Long VendorID, @Query("supplier_name") String name_supplier,
            @Query("uiid") String uuid, @Query("WorkerBranchISN") Long WorkerBranchISN, @Query("WorkerISN") Long WorkerISN, @Query("SelectedFoundation") int selectedFoundation,
            @Query("LogIn_BISN") String LogIn_BISN, @Query("LogIn_UID") String LogIn_UID, @Query("LogIn_WBISN") String LogIn_WBISN, @Query("LogIn_WISN") String LogIn_WISN,
            @Query("LogIn_WName") String LogIn_WName, @Query("LogIn_WSBISN") String LogIn_WSBISN, @Query("LogIn_WSISN") String LogIn_WSISN,
            @Query("LogIn_WSName") String LogIn_WSName, @Query("LogIn_CS") String LogIn_CS, @Query("LogIn_VN") String LogIn_VN, @Query("LogIn_FAlternative") String LogIn_FAlternative,
            @Query("MobileSalesMaxDiscPer") Integer MobileSalesMaxDiscPer, @Query("ShiftSystemActivate") Integer ShiftSystemActivate,
            @Query("LogIn_ShiftBranchISN") Integer LogIn_ShiftBranchISN, @Query("LogIn_ShiftISN") Integer LogIn_ShiftISN, @Query("LogIn_Spare1") Integer LogIn_Spare1,
            @Query("LogIn_Spare2") Integer LogIn_Spare2, @Query("LogIn_Spare3") Integer LogIn_Spare3, @Query("LogIn_Spare4") Integer LogIn_Spare4,
            @Query("LogIn_Spare5") Integer LogIn_Spare5, @Query("LogIn_Spare6") Integer LogIn_Spare6);

    @GET("dealer/get_customer_balance")
    Observable<CustomerBalance> getCustomerBalance(@Query("IllustrativeQuantity") Integer IllustrativeQuantity, @Query("DeviceID") String DeviceID, @Query("LogIn_CurrentWorkingDayDate") String LogIn_CurrentWorkingDayDate, @Query("VendorID") Long VendorID, @Query("uiid") String uuid, @Query("Dealer_ISN") String dealerISN, @Query("BranchISN") String branchISN, @Query("DealerType") String dealerType, @Query("SelectedFoundation") int selectedFoundation, @Query("LogIn_BISN") String LogIn_BISN, @Query("LogIn_UID") String LogIn_UID, @Query("LogIn_WBISN") String LogIn_WBISN, @Query("LogIn_WISN") String LogIn_WISN, @Query("LogIn_WName") String LogIn_WName, @Query("LogIn_WSBISN") String LogIn_WSBISN, @Query("LogIn_WSISN") String LogIn_WSISN, @Query("LogIn_WSName") String LogIn_WSName, @Query("LogIn_CS") String LogIn_CS, @Query("LogIn_VN") String LogIn_VN, @Query("LogIn_FAlternative") String LogIn_FAlternative, @Query("MoveBranchISN") String MoveBranchISN //invoice
            ...
            @Query("MobileSalesMaxDiscPer") Integer MobileSalesMaxDiscPer, @Query("ShiftSystemActivate") Integer ShiftSystemActivate,
            @Query("LogIn_ShiftBranchISN") Integer LogIn_ShiftBranchISN, @Query("LogIn_ShiftISN") Integer LogIn_ShiftISN,
            @Query("LogIn_Spare1") Integer LogIn_Spare1, @Query("LogIn_Spare2") Integer LogIn_Spare2,
            @Query("LogIn_Spare3") Integer LogIn_Spare3, @Query("LogIn_Spare4") Integer LogIn_Spare4,
            @Query("LogIn_Spare5") Integer LogIn_Spare5, @Query("LogIn_Spare6") Integer LogIn_Spare6
    ...
    Observable<SalesMan> getSalesMan(@Query("IllustrativeQuantity") Integer IllustrativeQuantity, @Query("DeviceID") String DeviceID,
            @Query("LogIn_CurrentWorkingDayDate") String LogIn_CurrentWorkingDayDate, @Query("VendorID") Long VendorID, @Query("sales_man") String sales_man,
            @Query("uiid") String uuid, @Query("WorkerBranchISN") Long WorkerBranchISN, @Query("WorkerISN") Long WorkerISN,
            @Query("SelectedFoundation") int selectedFoundation, @Query("LogIn_BISN") String LogIn_BISN, @Query("LogIn_UID") String LogIn_UID,
            @Query("LogIn_WBISN") String LogIn_WBISN, @Query("LogIn_WISN") String LogIn_WISN, @Query("LogIn_WName") String LogIn_WName,
            @Query("LogIn_WSBISN") String LogIn_WSBISN, @Query("LogIn_WSISN") String LogIn_WSISN, @Query("LogIn_WSName") String LogIn_WSName,
            ...
            @Query("MobileSalesMaxDiscPer") Integer MobileSalesMaxDiscPer, @Query("ShiftSystemActivate") Integer ShiftSystemActivate,
            @Query("LogIn_ShiftBranchISN") Integer LogIn_ShiftBranchISN, @Query("LogIn_ShiftISN") Integer LogIn_ShiftISN, @Query("LogIn_Spare1") Integer LogIn_Spare1,
            @Query("LogIn_Spare2") Integer LogIn_Spare2, @Query("LogIn_Spare3") Integer LogIn_Spare3, @Query("LogIn_Spare4") Integer LogIn_Spare4, @Query("LogIn_Spare5") Integer LogIn_Spare5, @Query("LogIn_Spare6") Integer LogIn_Spare6);

    @GET("stores/getStores")
    Observable<Stores> getStores(@Query("IllustrativeQuantity") Integer IllustrativeQuantity, @Query("DeviceID") String DeviceID, @Query("LogIn_CurrentWorkingDayDate") String LogIn_CurrentWorkingDayDate, @Query("VendorID") Long VendorID, @Query("BranchISN") Long BranchISN, @Query("permission") int permission, @Query("uiid") String uuid, @Query("CashierStoreBranchISN") Long CashierStoreBranchISN, @Query("CashierStoreISN") Long CashierStoreISN, @Query("AllBranchesWorker") int AllBranchesWorker, @Query("MoveType") int MoveType, @Query("SelectedFoundation") int selectedFoundation, @Query("LogIn_BISN") String LogIn_BISN, @Query("LogIn_UID") String LogIn_UID, @Query("LogIn_WBISN") String LogIn_WBISN, @Query("LogIn_WISN") String LogIn_WISN, @Query("LogIn_WName") String LogIn_WName, @Query("LogIn_WSBISN") String LogIn_WSBISN, @Query("LogIn_WSISN") String LogIn_WSISN, @Query("LogIn_WSName") String LogIn_WSName, @Query("LogIn_CS") String LogIn_CS, @Query("LogIn_VN") String LogIn_VN, @Query("LogIn_FAlternative") String LogIn_FAlternative, @Query("MobileSalesMaxDiscPer") Integer MobileSalesMaxDiscPer, @Query("ShiftSystemActivate") Integer ShiftSystemActivate, @Query("LogIn_ShiftBranchISN") Integer LogIn_ShiftBranchISN, @Query("LogIn_ShiftISN") Integer LogIn_ShiftISN, @Query("LogIn_Spare1") Integer LogIn_Spare1, @Query("LogIn_Spare2") Integer LogIn_Spare2, @Query("LogIn_Spare3") Integer LogIn_Spare3, @Query("LogIn_Spare4") Integer LogIn_Spare4, @Query("LogIn_Spare5") Integer LogIn_Spare5, @Query("LogIn_Spare6") Integer LogIn_Spare6);
    ...
    Observable<PriceType> getPriceType(@Query("IllustrativeQuantity") Integer IllustrativeQuantity, @Query("DeviceID") String DeviceID,
            @Query("LogIn_CurrentWorkingDayDate") String LogIn_CurrentWorkingDayDate, @Query("VendorID") Long VendorID, @Query("permission") int permission,
            @Query("uiid") String uuid, @Query("PricesTypeBranchISN") Long PricesTypeBranchISN, @Query("PricesTypeISN") Long PricesTypeISN,
            @Query("SelectedFoundation") int selectedFoundation, @Query("LogIn_BISN") String LogIn_BISN, @Query("LogIn_UID") String LogIn_UID,
            @Query("LogIn_WBISN") String LogIn_WBISN, @Query("LogIn_WISN") String LogIn_WISN, @Query("LogIn_WName") String LogIn_WName, @Query("LogIn_WSBISN") String LogIn_WSBISN,
            @Query("LogIn_WSISN") String LogIn_WSISN, @Query("LogIn_WSName") String LogIn_WSName, @Query("LogIn_CS") String LogIn_CS, @Query("LogIn_VN") String LogIn_VN,
            @Query("LogIn_FAlternative") String LogIn_FAlternative, @Query("PriceType") Integer PriceType, @Query("MobileSalesMaxDiscPer") Integer MobileSalesMaxDiscPer,
            @Query("ShiftSystemActivate") Integer ShiftSystemActivate, @Query("LogIn_ShiftBranchISN") Integer LogIn_ShiftBranchISN, @Query("LogIn_ShiftISN") Integer LogIn_ShiftISN, @Query("LogIn_Spare1") Integer LogIn_Spare1, @Query("LogIn_Spare2") Integer LogIn_Spare2, @Query("LogIn_Spare3") Integer LogIn_Spare3, @Query("LogIn_Spare4") Integer LogIn_Spare4, @Query("LogIn_Spare5") Integer LogIn_Spare5, @Query("LogIn_Spare6") Integer LogIn_Spare6);

    @GET("banks/getBanks")
    Observable<Banks> getBanks(@Query("IllustrativeQuantity") Integer IllustrativeQuantity, @Query("DeviceID") String DeviceID, @Query("LogIn_CurrentWorkingDayDate") String LogIn_CurrentWorkingDayDate, @Query("VendorID") Long VendorID, @Query("BranchISN") long BranchISN, @Query("permission") int permission, @Query("uiid") String uuid, @Query("SelectedFoundation") int selectedFoundation, @Query("LogIn_BISN") String LogIn_BISN, @Query("LogIn_UID") String LogIn_UID, @Query("LogIn_WBISN") String LogIn_WBISN, @Query("LogIn_WISN") String LogIn_WISN, @Query("LogIn_WName") String LogIn_WName, @Query("LogIn_WSBISN") String LogIn_WSBISN, @Query("LogIn_WSISN") String LogIn_WSISN, @Query("LogIn_WSName") String LogIn_WSName, @Query("LogIn_CS") String LogIn_CS, @Query("LogIn_VN") String LogIn_VN, @Query("LogIn_FAlternative") String LogIn_FAlternative, @Query("MobileSalesMaxDiscPer") Integer MobileSalesMaxDiscPer, @Query("ShiftSystemActivate") Integer ShiftSystemActivate, @Query("LogIn_ShiftBranchISN") Integer LogIn_ShiftBranchISN, @Query("LogIn_ShiftISN") Integer LogIn_ShiftISN, @Query("LogIn_Spare1") Integer LogIn_Spare1, @Query("LogIn_Spare2") Integer LogIn_Spare2, @Query("LogIn_Spare3") Integer LogIn_Spare3, @Query("LogIn_Spare4") Integer LogIn_Spare4, @Query("LogIn_Spare5") Integer LogIn_Spare5, @Query("LogIn_Spare6") Integer LogIn_Spare6);

    @GET("product/getProductTest")
    Observable<Product> getProductCustomer(@Query("IllustrativeQuantity") Integer IllustrativeQuantity, @Query("DeviceID") String DeviceID, @Query("LogIn_CurrentWorkingDayDate") String LogIn_CurrentWorkingDayDate, @Query("VendorID") Long VendorID, @Query("product_name") String productName, @Query("uiid") String uuid, @Query("PricesTypeBranchISN") long pricesTypeBranchISN, @Query("PricesTypeISN") long pricesTypeISN, @Query("DealerType") int dealerType, @Query("Dealer_ISN") long dealer_ISN, @Query("BranchISN") int BranchISN, @Query("CurrentBranchISN") int CurrentBranchISN, @Query("AllowSpecificDealersPrices") int AllowSpecificDealersPrices, @Query("MoveType") int moveType, @Query("Serial") String serial, @Query("SelectedFoundation") int selectedFoundation, @Query("LogIn_BISN") String LogIn_BISN, @Query("LogIn_UID") String LogIn_UID, @Query("LogIn_WBISN") String LogIn_WBISN, @Query("LogIn_WISN") String LogIn_WISN, @Query("LogIn_WName") String LogIn_WName, @Query("LogIn_WSBISN") String LogIn_WSBISN, @Query("LogIn_WSISN") String LogIn_WSISN, @Query("LogIn_WSName") String LogIn_WSName, @Query("LogIn_CS") String LogIn_CS, @Query("LogIn_VN") String LogIn_VN, @Query("LogIn_FAlternative") String LogIn_FAlternative, @Query("MobileSalesMaxDiscPer") Integer MobileSalesMaxDiscPer, @Query("ShiftSystemActivate") Integer ShiftSystemActivate, @Query("LogIn_ShiftBranchISN") Integer LogIn_ShiftBranchISN, @Query("LogIn_ShiftISN") Integer LogIn_ShiftISN, @Query("LogIn_Spare1") Integer LogIn_Spare1, @Query("LogIn_Spare2") Integer LogIn_Spare2, @Query("LogIn_Spare3") Integer LogIn_Spare3, @Query("LogIn_Spare4") Integer LogIn_Spare4, @Query("LogIn_Spare5") Integer LogIn_Spare5, @Query("LogIn_Spare6") Integer LogIn_Spare6);
    ...
    @GET("product/getProductTest")
    Observable<Product> getProduct(@Query("IllustrativeQuantity") Integer IllustrativeQuantity, @Query("DeviceID") String DeviceID, @Query("LogIn_CurrentWorkingDayDate") String LogIn_CurrentWorkingDayDate, @Query("VendorID") Long VendorID, @Query("product_name") String productName, @Query("uiid") String uuid, @Query("PricesTypeBranchISN") long pricesTypeBranchISN, @Query("PricesTypeISN") long pricesTypeISN, @Query("AllowSpecificDealersPrices") int AllowSpecificDealersPrices, @Query("CurrentBranchISN") int CurrentBranchISN, @Query("MoveType") int moveType, @Query("Serial") String serial, @Query("SelectedFoundation") int selectedFoundation, @Query("LogIn_BISN") String LogIn_BISN, @Query("LogIn_UID") String LogIn_UID, @Query("LogIn_WBISN") String LogIn_WBISN, @Query("LogIn_WISN") String LogIn_WISN, @Query("LogIn_WName") String LogIn_WName, @Query("LogIn_WSBISN") String LogIn_WSBISN, @Query("LogIn_WSISN") String LogIn_WSISN, @Query("LogIn_WSName") String LogIn_WSName, @Query("LogIn_CS") String LogIn_CS, @Query("LogIn_VN") String LogIn_VN, @Query("LogIn_FAlternative") String LogIn_FAlternative, @Query("MobileSalesMaxDiscPer") Integer MobileSalesMaxDiscPer, @Query("ShiftSystemActivate") Integer ShiftSystemActivate, @Query("LogIn_ShiftBranchISN") Integer LogIn_ShiftBranchISN, @Query("LogIn_ShiftISN") Integer LogIn_ShiftISN, @Query("LogIn_Spare1") Integer LogIn_Spare1, @Query("LogIn_Spare2") Integer LogIn_Spare2, @Query("LogIn_Spare3") Integer LogIn_Spare3, @Query("LogIn_Spare4") Integer LogIn_Spare4, @Query("LogIn_Spare5") Integer LogIn_Spare5, @Query("LogIn_Spare6") Integer LogIn_Spare6, @Query("ItemCode") String itemCode);
    ...
    Observable<InvoiceResponse> checkItem(@Field("IllustrativeQuantity") Integer IllustrativeQuantity, @Field("DeviceID") String DeviceID, @Field("LogIn_CurrentWorkingDayDate") String LogIn_CurrentWorkingDayDate, @Field("VendorID") Long VendorID, @Field("uiid") String uuid, @Field("ItemBranchISN[]") ArrayList<Long> ItemBranchISN, @Field("ItemISN[]") ArrayList<Long> ItemISN, @Field("PriceTypeBranchISN[]") ArrayList<Long> PriceTypeBranchISN, @Field("PriceTypeISN[]") ArrayList<Long> PriceTypeISN, @Field("StoreBranchISN[]") ArrayList<Long> StoreBranchISN, @Field("StoreISN[]") ArrayList<Long> StoreISN, @Field("BasicQuantity[]") ArrayList<Float> BasicQuantity, @Field("BonusQuantity[]") ArrayList<Float> BonusQuantity, @Field("TotalQuantity[]") ArrayList<Float> TotalQuantity,
            ...
            @Field("MobileSalesMaxDiscPer") Integer MobileSalesMaxDiscPer, @Field("ShiftSystemActivate") Integer ShiftSystemActivate,
    ...
    Observable<Invoice> getPrintingData(@Query("IllustrativeQuantity") Integer IllustrativeQuantity,
            ...
            @Query("LogIn_FAlternative") String LogIn_FAlternative, @Query("MobileSalesMaxDiscPer") Integer MobileSalesMaxDiscPer,
    ...
    Observable<StoreReportModel> getStoresReport(@Query("IllustrativeQuantity") Integer IllustrativeQuantity,
            ...
            @Query("LogIn_WSBISN") String LogIn_WSBISN, @Query("LogIn_WSISN") String LogIn_WSISN, @Query("LogIn_WSName") String LogIn_WSName,
            @Query("LogIn_CS") String LogIn_CS, @Query("LogIn_VN") String LogIn_VN, @Query("LogIn_FAlternative") String LogIn_FAlternative,
            @Query("MobileSalesMaxDiscPer") Integer MobileSalesMaxDiscPer, @Query("ShiftSystemActivate") Integer ShiftSystemActivate, @Query("LogIn_ShiftBranchISN") Integer LogIn_ShiftBranchISN,
            @Query("LogIn_ShiftISN") Integer LogIn_ShiftISN, @Query("LogIn_Spare1") Integer LogIn_Spare1, @Query("LogIn_Spare2") Integer LogIn_Spare2,
            @Query("LogIn_Spare3") Integer LogIn_Spare3, @Query("LogIn_Spare4") Integer LogIn_Spare4, @Query("LogIn_Spare5") Integer LogIn_Spare5,
            @Query("LogIn_Spare6") Integer LogIn_Spare6);
    ...
    Observable<ItemPriceResponse> getItemPrice(@Query("IllustrativeQuantity") Integer IllustrativeQuantity, @Query("DeviceID") String DeviceID, @Query("LogIn_CurrentWorkingDayDate") String LogIn_CurrentWorkingDayDate, @Query("VendorID") Long VendorID, @Query("uiid") String uiid, @Query("ItemBranchISN") int itemBranchISN, @Query("ItemISN") int itemISN, @Query("WorkerName") String WorkerName, @Query("user_name") String user_name, @Query("WorkStationName") String WorkStationName, @Query("WorkStation_ISN") String WorkStation_ISN, @Query("WorkStationBranchISN") String WorkStationBranchISN, @Query("SelectedFoundation") int selectedFoundation, @Query("LogIn_BISN") String LogIn_BISN, @Query("LogIn_UID") String LogIn_UID, @Query("LogIn_WBISN") String LogIn_WBISN, @Query("LogIn_WISN") String LogIn_WISN, @Query("LogIn_WName") String LogIn_WName, @Query("LogIn_WSBISN") String LogIn_WSBISN, @Query("LogIn_WSISN") String LogIn_WSISN, @Query("LogIn_WSName") String LogIn_WSName, @Query("LogIn_CS") String LogIn_CS, @Query("LogIn_VN") String LogIn_VN, @Query("LogIn_FAlternative") String LogIn_FAlternative, @Query("PriceType") Integer PriceType, @Query("MobileSalesMaxDiscPer") Integer MobileSalesMaxDiscPer, @Query("ShiftSystemActivate") Integer ShiftSystemActivate, @Query("LogIn_ShiftBranchISN") Integer LogIn_ShiftBranchISN, @Query("LogIn_ShiftISN") Integer LogIn_ShiftISN, @Query("LogIn_Spare1") Integer LogIn_Spare1, @Query("LogIn_Spare2") Integer LogIn_Spare2, @Query("LogIn_Spare3") Integer LogIn_Spare3, @Query("LogIn_Spare4") Integer LogIn_Spare4, @Query("LogIn_Spare5") Integer LogIn_Spare5, @Query("LogIn_Spare6") Integer LogIn_Spare6);
